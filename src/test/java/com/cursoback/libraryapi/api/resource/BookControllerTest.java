...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception {
        ...
        Book savedBook = Book.builder().id(1L).author("Arthur").title("Aventuras")
                .isbn("001").build();
    ...
    @Test
    @DisplayName("Deve lançar erro de validação qunad não houver dados suficiente.")
    ...
    @Test
    @DisplayName("Deve retornar resource not found quando não encontrar umm livro para deletar")
    ...
    public void updateBookTest() throws Exception {
        ...
        Book updatingBook = Book.builder().id(id).title("some title").author("some author")
                .isbn("001").build();
        BDDMockito.given(service.getById(id))
                .willReturn(Optional.of(updatingBook));

        Book updatedBook = Book.builder().id(id).author("Arthur").title("Aventuras")
                .isbn("001").build();
    ...
    private static BookDTO createNewBook() {
        return BookDTO.builder().author("Arthur").title("Aventuras")
                .isbn("001").build();
    }
}
